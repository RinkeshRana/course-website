      ...
      <div className="w-screen md:w-1/2 flex-col ">
        <div className=" p-6 md:p-12 md:ml-40    h-3/4 flex flex-col justify-evenly md:items-start">
          <h3 className="dark:text-white text-2xl md:text-3xl uppercase tracking-widest font-bold leading-10">
            Explore the{" "}
            <span
              className=" font-extrabold text-transparent bg-clip-text bg-gradient-to-br dark:from-red-400 dark:to-orange-400 from-blue-400 to-green-400 dark:via-pink-500via-yellow-500
                           "
            >
              best
            </span>
          ...
          <div>
            <h1 className="dakr:text-gray-400 text-lg md:text-2xl font-semibold sm:leading-12">
              Courses Duniya is a{" "}
